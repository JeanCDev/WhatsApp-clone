...
export class WhatsAppController {
    ...
    // inicia autenticação no firebase 
    initAuth() {
        ...
        Message.getRef(this._contactActive.chatId)
            .orderBy('timeStamp').onSnapshot(docs => {
                ...
                docs.forEach(doc =>{
                    ...
                    // verifica se a mensagem é um contato anexado e abre um chat com o mesmo
    ...
    elementsPrototype() {
        ...
        // adiciona styles css em um elemento
